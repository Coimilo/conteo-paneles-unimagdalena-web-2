...
if img_ready:
    try:
        ...
        with tab1:
            ...
            # Histograma ROI Superior configurado
            ...
            axs_hist[0].set_xlabel("Nivel de Intensidad (0 - 255)")
            axs_hist[0].set_ylabel("Cantidad de Píxeles")
            axs_hist[0].legend(loc="upper right")
            axs_hist[0].grid(True, alpha=0.3)
            
            # Histograma ROI Inferior configurado
            ...
            axs_hist[1].set_xlabel("Nivel de Intensidad (0 - 255)")
            axs_hist[1].set_ylabel("Cantidad de Píxeles")
        ...
        with tab4:
            ...
            cv2.drawContours(roi_sup_draw, paneles_sup, -1, (255, 0, 100), 3)
